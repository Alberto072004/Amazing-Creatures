...
var character_direction : Vector2 #Variable para almacenar la dirección de movimiento del personaje como un vector (x, y).
var direction = "none"
...
#Función que gestiona la entrada del jugador, el movimiento y la lógica de la dirección.
...
#Función para reproducir la animación correcta
